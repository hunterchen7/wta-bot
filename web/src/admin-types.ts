...
export type ParticipantRow = {
  id: number; discord_id: string; discord_username: string | null; name: string | null; preferred_email: string | null; western_email: string | null;
...
export type ProblemsData = { problems: ProblemRow[]; sets: Array<{ week_id: number; round: number; cohort_name: string; problem_id: number; title: string }> };
...
export type OutboxRow = { id: number; kind: string; attempts: number; run_after: string; done_at: string | null; last_error: string | null; created_at: string };
