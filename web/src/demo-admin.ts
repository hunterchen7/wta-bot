...
const problems: ProblemsData['problems'] = [
  { id: 1, source: 'leetcode', number: 56, title: 'Merge Intervals', url: 'https://leetcode.com/problems/merge-intervals/', difficulty: 'medium', difficulty_rank: 2.3, content_md: '## Statement\n\nGiven an array of intervals, merge overlapping intervals.\n\n## Hints\n\nSort by start time.\n\n## Solution\n\nSort, then scan once.', available_weeks: [2], statement_md: 'Given an array of intervals, merge overlapping intervals.', interviewer_notes_md: 'Sort by start time.\n\n## Intended solution\n\nSort, then scan once.', hints_md: 'Sort by start time.\nTrack the current merged interval.', solution_md: 'Sort, then scan once.', execution: { mode: 'stdin_tests', languages: ['python'], starterCode: { python: 'print(input())' }, testCases: [{ description: 'overlapping ranges', input: '[[1,3],[2,6]]', expectedOutput: '[[1,6]]', isHidden: false }, { description: 'disjoint ranges', input: '[[1,2],[4,5]]', expectedOutput: '[[1,2],[4,5]]', isHidden: true }] }, active: 1, uses: 8, exposures: 16 },
  { id: 2, source: 'leetcode', number: 20, title: 'Valid Parentheses', url: 'https://leetcode.com/problems/valid-parentheses/', difficulty: 'easy', difficulty_rank: 1.1, content_md: '## Statement\n\nDetermine whether brackets are balanced.\n\n## Hints\n\nUse a stack.\n\n## Solution\n\nPush openers and match closers.', available_weeks: [1, 2], statement_md: 'Determine whether brackets are balanced.', interviewer_notes_md: 'Use a stack.\n\n## Intended solution\n\nPush openers and match closers.', hints_md: 'Use a stack.', solution_md: 'Push openers and match closers.', execution: { mode: 'manual' }, active: 1, uses: 6, exposures: 12 },
  { id: 3, source: 'leetcode', number: 200, title: 'Number of Islands', url: 'https://leetcode.com/problems/number-of-islands/', difficulty: 'medium', difficulty_rank: 2.6, content_md: '## Statement\n\nCount connected land components.\n\n## Hints\n\nTry DFS or BFS.\n\n## Solution\n\nFlood-fill each unseen land cell.', available_weeks: [2, 3], statement_md: 'Count connected land components.', interviewer_notes_md: 'Try DFS or BFS.\n\n## Intended solution\n\nFlood-fill each unseen land cell.', hints_md: 'Try DFS or BFS.', solution_md: 'Flood-fill each unseen land cell.', execution: { mode: 'manual' }, active: 1, uses: 5, exposures: 10 },
  { id: 4, source: 'manual', number: null, title: 'Legacy Graph Exercise', url: null, difficulty: 'hard', difficulty_rank: 3.2, content_md: '## Statement\n\nLegacy exercise.\n\n## Hints\n\n\n\n## Solution\n\n', available_weeks: [3], statement_md: null, interviewer_notes_md: '', hints_md: null, solution_md: null, execution: { mode: 'manual' }, active: 0, uses: 0, exposures: 0 },
];
...
export async function adminDemoRequest(path: string, init?: RequestInit): Promise<unknown> {
  ...
  if (path === '/settings') return { settings: { announce_channel_id: '10829384012', pairing_channel_id: '10829384015', organizer_channel_id: '10829384013', threads_channel_id: '10829384014', organizer_role_id: '10829384099', participant_role_id: '10829384098', packet_mode: 'on', packet_lead_hours: '24', question_bank_public: 'off' }, cohorts: [cohort, { id: 0, name: 'Summer 2025', start_date: '2025-07-20', weeks_count: 3, status: 'done' }], timeline: [
