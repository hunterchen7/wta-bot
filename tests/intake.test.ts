...
describe('web enrollment cutover', () => {
  ...
  it('saves the full profile, Discord mapping, role grant, nickname, and email confirmation together', async () => {
    ...
    expect(participant).toMatchObject({ discord_username: 'test.student', name: 'Test Student', preferred_email: 'test@example.com', topics: '["dsa","system_design"]', email_ok: 1, status: 'active' });
